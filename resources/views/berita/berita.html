    ...
    <article class="container mt-28">
      ...
      <div class="mt-11">
        <div class="space-y-[14px] mb-3">
          ...
          >
            ALAT PEMOTONG ADONAN KERUPUK UNTUK UMKM J&R DESA DUWET KECAMATAN
          ...
          >
            <div class="flex gap-[10px] items-center">
              ...
              <span>by <span class="text-xneutral-400">Admin</span></span>
            </div>
        ...
        >
          Dalam rangka pengabdian masyarakat dan tugas akhir mahasiswa,
          mahasiswa D3 Teknik Mesin Polinema membuat alat pemotong adonan
          kerupuk untuk UMKM J&R Dinoyo Malang. UMKM J7R merupakan produsen
          kerupuk berbahan ketela, yang dimiliki oleh pak Junaedi. selama ini
          proses pemotongan adonan dilakukan secara manual sehingga membutuhkan
          waktu lama. Dengan adanya alat pemotong adonan ini, kapasitas
          pemotongannya bisa mencapai 100 kg per jam. Kapasitas yang sama jika
          dilakukan secara manual oleh 2 orang membutuhkan waktu sekitar 2 jam.
        </p>
        <div
          class="max-h-[430px] rounded-3xl overflow-hidden object-cover w-full mt-4"
        >
          <img src="/assets/images/berita.png" alt="Berita" />
        </div>
      </div>
    </article>
