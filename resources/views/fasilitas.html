  ...
  <body>
    ...
    <article class="container mt-28">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-12 gap-8 mt-8">
        <img
          src="/assets/images/fasilitas-1.png"
          alt="Laboratorium Sistem dan Teknologi Informasi"
          class="w-full h-fit object-cover rounded-[30px] sm:col-span-5"
        />
        <div class="sm:col-span-7">
          <h3
            class="font-montserrat text-xl sm:text-2xl font-semibold text-xneutral-400 mb-5"
          >
            Laboratorium Sistem dan Teknologi Informasi
          </h3>
          <p
            class="font-montserrat font-medium text-sm sm:text-base text-justify text-xneutral-300"
          >
            Laboratorium Sistem dan Teknologi Informasi berfokus kepada
            pengembangan sistem Informasi antara lain Enterprise System,
            Business Process Management, Business Modelling, Data and Knowledge
            Management, dan Information System Management. Lab STI juga
            diharapkan dapat menjadi wadah berbagai riset keahlian Sistem
            Informasi mulai dari aspek strategis, manajemen proyek, peningkatan
            performa proses bisnis dengan dukungan SI/TI sampai pada evaluasi
            kinerja TI dalam mendukung organisasi.
          </p>
          <h3
            class="font-montserrat font-semibold text-sm sm:text-base text-xneutral-400 mt-[14px] mb-1.5"
          >
            Topik Penelitian
          </h3>
          <ul
            class="list-disc pl-5 font-montserrat text-sm sm:text-base text-xneutral-300 font-medium"
          >
      ...
      <div class="grid grid-cols-1 sm:grid-cols-12 gap-8 mt-20">
        <img
          src="/assets/images/fasilitas-2.png"
          alt="Laboratorium ICD"
          class="w-full h-fit object-cover rounded-[30px] sm:col-span-5"
        />
        <div class="sm:col-span-7">
          <h3
          ...
          <p
            class="font-montserrat font-medium text-sm sm:text-base text-justify text-xneutral-300"
          >
            Laboratorium ICD adalah laboratorium yang digunakan untuk
            pembelajaran ilmu kesehatan dan diagnosis penyakit serta tindakan
            yang harus dilakukan. Lab ini sebagai dasar penunjang dalam
            pembuatan teknologi kesehatan berbasis kecerdasan buatan.
          </p>
          <h3
            class="font-montserrat font-semibold text-sm sm:text-base text-xneutral-400 mt-[14px] mb-1.5"
          >
